...
public class DatosFantasy {
	...
	public Equipo_Fantasia equipoNuevo;
	...
	public boolean AgregarJugador(String jugador) {
		...
		boolean limitePos = equipoNuevo.limitePos(infoJugador.darPosicion(), 1);
		...
		if (existe == true) {
			...
			if (infoJugador.darPosicion().equals("portero")) {
				equipoNuevo.porteros++;
			}
			if (infoJugador.darPosicion().equals("defensa")) {
				equipoNuevo.defensas ++;
			}
			if (infoJugador.darPosicion().equals("mediocentro")) {
				equipoNuevo.medios ++;
			}
			if (infoJugador.darPosicion().equals("delantero")) {
				equipoNuevo.delanteros ++;
			}
			if (equipoNuevo.porteros + equipoNuevo.defensas + equipoNuevo.medios + equipoNuevo.delanteros == 15 ) {
				equipoNuevo.equipoNoCompleto = false;
			}
	...
	public boolean limitePos(String posicion, int porteros, int defensas, int mediocentros, int delanteros, int tipo_equipo) {
		if (tipo_equipo == 1) {
	...
	public boolean tienePresupuesto(int precio, int presupuesto) {
	...
	public void ejecutarCargarJugadores() {
		try
		{
	...
	public ArrayList ejecutarAccederListaJugadores() {
